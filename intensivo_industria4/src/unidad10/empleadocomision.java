...
public class empleadocomision extends ejercicio1012
{
 private double ventasBrutas; 
 private double tarifaComision; 


 public empleadocomision(String primerNombre, String apellidoPaterno, String numeroSeguroSocial, double ventasBrutas, double tarifaComision){
